...
class ProfilePageForm(forms.ModelForm):
    class Meta:
        ...
        widget = {
                ...
                'website-url':forms.TextInput(attrs={'class':'form-control'}),
...
# editing django´s native forms
# bootstrapify with  widgets directly in the form,new fields
# see in the devs tools the name of the fields used by django-TextInput or
# CheckboxInput for instance   
    email = forms.EmailField(widget = forms.EmailInput(attrs={'class':'form-control'}))
    first_name = forms.CharField(max_length=100, widget= forms.TextInput(attrs={'class':'form-control'}))
    last_name = forms.CharField(max_length=100,widget=forms.TextInput(attrs={'class':'form-control'}))
    ...
    class Meta:
        model = User
        # the order of the fields will the same in the page
